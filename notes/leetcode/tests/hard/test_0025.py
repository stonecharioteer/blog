"""Test for Leetcode #25 - Reverse a LinkedList in groups of size k"""
import sys
import pathlib

try:
    code_folder = "solutions/0025_reverse_nodes_in_k_group"
    ...
    raise ImportError(
        ...
        "from solutions/0025_reverse_nodes_in_k_group, "
        "are you sure the solution exists?"
    )


def test_reverse_nodes_in_k_group():
    """simple test case for #25: `Reverse a LinkedList in groups of size k`"""
    positional_inputs = []
    named_inputs = {}

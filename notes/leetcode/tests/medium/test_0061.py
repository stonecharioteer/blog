"""Test for Leetcode #61 - Rotate a LinkedList"""
import sys
import pathlib

try:
    code_folder = "solutions/0061_description"
    ...
    raise ImportError(
        ...
        "from solutions/0061_description, "
        "are you sure the solution exists?"
    )


def test_description():
    """simple test case for #61: `Rotate a LinkedList`"""
    positional_inputs = []
    named_inputs = {}

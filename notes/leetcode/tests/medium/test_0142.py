"""Test for Leetcode #142 - Find the starting point of the Loop of LinkedList"""
import sys
import pathlib

try:
    code_folder = "solutions/0142_linked_list_cycle_ii"
    ...
    raise ImportError(
        ...
        "from solutions/0142_linked_list_cycle_ii, "
        "are you sure the solution exists?"
    )


def test_linked_list_cycle_ii():
    """simple test case for #142: `Find the starting point of the Loop of LinkedList`"""
    positional_inputs = []
    named_inputs = {}

"""Test for Leetcode #238 - Product of Array Except Self"""
import pathlib
import sys

try:
    code_folder = "solutions/0238_product_of_array_except_self"
    ...
    raise ImportError(
        ...
        "from solutions/0238_product_of_array_except_self, "
        "are you sure the solution exists?"
    )


def test_product_of_array_except_self():
    """simple test case for #238: `Product of Array Except Self`"""
    positional_inputs = []
    named_inputs = {}

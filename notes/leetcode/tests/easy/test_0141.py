"""Test for Leetcode #141 - Detect a cycle in Linked List"""
import sys
import pathlib

try:
    code_folder = "solutions/0141_linked_list_cycle"
    ...
    raise ImportError(
        ...
        "from solutions/0141_linked_list_cycle, "
        "are you sure the solution exists?"
    )


def test_linked_list_cycle():
    """simple test case for #141: `Detect a cycle in Linked List`"""
    positional_inputs = []
    named_inputs = {}

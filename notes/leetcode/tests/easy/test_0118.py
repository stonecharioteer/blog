"""Test for Leetcode #118 - Pascal's Triangle"""
import sys
import pathlib

try:
    code_folder = "solutions/0118_pascals_triangle"
    ...
    raise ImportError(
        ...
        "from solutions/0118_pascals_triangle, "
        "are you sure the solution exists?"
    )


def test_pascals_triangle():
    """simple test case for #118: `Pascal's Triangle`"""
    positional_inputs = []
    named_inputs = {}

"""Test for Leetcode #53 - Kadane's Algorithm"""
import sys
import pathlib

try:
    code_folder = "solutions/0053_maximum_subarray"
    ...
    raise ImportError(
        ...
        "from solutions/0053_maximum_subarray, "
        "are you sure the solution exists?"
    )


def test_maximum_subarray():
    """simple test case for #53: `Kadane's Algorithm`"""
    positional_inputs = []
    named_inputs = {}

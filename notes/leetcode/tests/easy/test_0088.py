"""Test for Leetcode #88 - Merge two sorted Arrays without extra space"""
import sys
import pathlib

try:
    code_folder = "solutions/0088_merge_sorted_array"
    ...
    raise ImportError(
        ...
        "from solutions/0088_merge_sorted_array, "
        "are you sure the solution exists?"
    )


def test_merge_sorted_array():
    """simple test case for #88: `Merge two sorted Arrays without extra space`"""
    positional_inputs = []
    named_inputs = {}

...
.. note::
   ...
   Additionally, I have also moved to a physical notes system for books, and I
   later digitize my notes, so these notes will not be up to date.
...
.. toctree::
   ...
   common_sense_guide/index.rst
   cpython_internals/index.rst
   ctci/index.rst
   database_internals/index.rst
   elements_of_programming_interviews/index.rst
   high_performance_browser_networking/index.rst
   k8s_in_action/index.rst
   kleppmann/index.rst
   practices_python_pro/index.rst
   problem_solving_dsa_python/index.rst
   secure_by_design/index.rst
   ultralearning/index.rst

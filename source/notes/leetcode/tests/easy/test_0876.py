"""Test for Leetcode #876 - Find the middle of LinkedList"""
import sys
import pathlib

try:
    code_folder = "solutions/0876_middle_of_the_linked_list"
    ...
    raise ImportError(
        ...
        "from solutions/0876_middle_of_the_linked_list, "
        "are you sure the solution exists?"
    )


def test_middle_of_the_linked_list():
    """simple test case for #876: `Find the middle of LinkedList`"""
    positional_inputs = []
    named_inputs = {}

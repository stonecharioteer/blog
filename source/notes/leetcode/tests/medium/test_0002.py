"""Test for Leetcode #2 - Add two numbers as LinkedList"""
import sys
import pathlib

try:
    code_folder = "solutions/0002_add_two_numbers"
    ...
    raise ImportError(
        ...
        "from solutions/0002_add_two_numbers, "
        "are you sure the solution exists?"
    )


def test_add_two_numbers():
    """simple test case for #2: `Add two numbers as LinkedList`"""
    positional_inputs = []
    named_inputs = {}

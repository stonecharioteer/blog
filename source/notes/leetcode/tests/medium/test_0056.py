"""Test for Leetcode #56 - Merge Overlapping Subintervals"""
import sys
import pathlib

try:
    code_folder = "solutions/0056_merge_intervals"
    ...
    raise ImportError(
        ...
        "from solutions/0056_merge_intervals, "
        "are you sure the solution exists?"
    )


def test_merge_intervals():
    """simple test case for #56: `Merge Overlapping Subintervals`"""
    positional_inputs = []
    named_inputs = {}
